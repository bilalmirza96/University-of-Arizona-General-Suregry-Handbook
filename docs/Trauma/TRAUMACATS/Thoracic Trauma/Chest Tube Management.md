...
2. **Apply –20 mmHg suction** to all chest tubes.
3. **Obtain imaging** (CXR) to confirm proper placement and lung re-expansion.
...
1. **Chest tube placement → suction → confirm on CXR**
2. **At 24h:**
...
3. **After water seal (4h):**
   - If no PTX/air leak → remove chest tube  
4. **If CT shows RH >300 mL:**
   - **Poor candidate:** IPFT  
